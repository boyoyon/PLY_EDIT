...
　　(例)<br>
　　g　r　0　10　0　t　0　1/(36*6)　0　36*6　# y 軸周りに10°回転を 36(一周)×6回(=6周)したらy方向に +1
</p>


<p>
　<strong>p2コマンド：　p2pオプション</strong><br>
　　P2[ ] 内の n,m,3 データを n×m, 3 データに reshape して Points[ ] に格納する。<br>
<br>
　　亀甲金網を作成するために追加。
</p>
<img src="images/kikko_kanaami.png"><br>

<p>
　　(例)<br>
　　　① p　clear　　　　　　　　　　　　　　　　　　･･･　Points[ ]を空にする<br>
　　　② p　0.1　0　0　　　　　　　　　　　　　　　　･･･　3D　座標 (0.1,0,0) を追加<br>
　　　③ p　g　r　0　10　0　t　0　1/(36*6)　0　36*6　･･･　(y 方向に 1/(36×6) 上昇 ＋ y 軸周り 10°回転)を 36×6 回(=6周したら+1上昇)<br>
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 Points[ ]：変換後の 1 点<br>
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 P2[ ]：36×6 点の軌跡<br>
　　　④ p2　p2p　　　　　　　　　　　　　　　　　　･･･　P2[ ]の内容が Points[ ]に移動される<br>
</p>

<img src="images/p2p0.svg"><br>

<p>

　　　⑤ p　t　np.sqrt(3)/2　1.5　0　2　　　　　　　　･･･　斜め上に移動<br>
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　Points[ ]：移動後の螺旋１個<br>
　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　P2[ ]：移動前後の螺旋２個<br>
　　　⑥ p2　p2p　　　　　　　　　　　　　　　　　　･･･　P2[ ]の内容が Points[ ]に移動される<br>
　　　⑦ polyline　　　　　　　　　　　　　　　　　　 ･･･　2個の螺旋と、それらを結ぶ直線がメッシュ化される。
...
　　SurfaceOuter/SurfaceInner/LateralOuter/LateralInner/PaddingOuter/PaddingInner を設定するオプションを追加した<br>
<br>
　<strong>　push/pop オプション</strong><br>
　　SurfaceOuter/SurfaceInner/LateralOuter/LateralInner/PaddingOuter/PaddingInner を push/pop するオプションを追加した<br>
</p>

<img src="images/c_command.svg"><br>
...
<p>
　<strong>3D座標配列のpush、pop</strong><br>
</p>
<img src="images/push_pop.svg">
<p>
